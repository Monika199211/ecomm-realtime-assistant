...
async def main():
    client = MultiServerMCPClient({
        "hybrid_search": {   # server name
            "command": "python",
            "args": [
                r"/Users/monikabadadhe/Documents/AI_Projects/ecomm-prod-assistant-monika/prod_assistant/mcp_servers/product_search_server.py"
            ],  # absolute path
            "transport": "stdio",
        }
    })
    ...
    # query = "iPhone 15"
    query = "What is the rating of iPhone 16?"
